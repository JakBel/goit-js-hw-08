...
'use strict'; // Add imports above this line
...
require("./../../node_modules/simplelightbox/dist/simple-lightbox.min.css");
...
const imagesContainer = _galleryItems.galleryItems.map(galleryItem => `<a class="gallery__item" href="${galleryItem.original}"> <img class="gallery__image" src="${galleryItem.preview}" data-caption="${galleryItem.description}" alt="${galleryItem.description}"/></a>`).join('');
